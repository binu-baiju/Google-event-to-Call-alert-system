          ...
          <div className="relative z-10 mx-auto max-w-2xl text-center">
            ...
            <FadeUp delay={0.5}>
              <p className="mx-auto mt-6 max-w-lg text-base text-muted-foreground sm:text-lg">
                ...
                reminder before every upcoming event. Simple, reliable,
                hands-free.
              </p>
            </FadeUp>
              ...
              {[
                {
                  ...
                  description:
                    "Read-only access with automatic token refresh.",
                },
                {
                  icon: Phone,
                  title: "Twilio Calls",
                  description:
                    "Voice calls with event name and start time.",
                },
                {
                  icon: Shield,
                  title: "Secure",
                  description:
                    "OAuth 2.0, encrypted tokens, CRON_SECRET auth.",
                },
                {
                  icon: Zap,
                  title: "Idempotent",
                  description:
                    "No duplicate calls. Smart deduplication built-in.",
                },
              ].map((feature) => (
